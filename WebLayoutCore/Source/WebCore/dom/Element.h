...
public:
    ...
    bool hasAttributesWithoutUpdate() const;
     ...
     ExceptionOr<void> setAttribute(const AtomicString& name, const AtomicString& value);
    static ExceptionOr<QualifiedName> parseAttributeName(const AtomicString& namespaceURI, const AtomicString& qualifiedName);
     ExceptionOr<void> setAttributeNS(const AtomicString& namespaceURI, const AtomicString& qualifiedName, const AtomicString& value);
    ...
    unsigned findAttributeIndexByName(const AtomicString& name, bool shouldIgnoreAttributeCase) const { return elementData()->findAttributeIndexByName(name, shouldIgnoreAttributeCase); }
     ...
     void scrollIntoViewIfNotVisible(bool centerIfNotVisible = true);
    ...
    Ref<Attr> detachAttribute(unsigned index);
     ...
     ExceptionOr<RefPtr<Attr>> setAttributeNode(Attr&);
     ExceptionOr<RefPtr<Attr>> setAttributeNodeNS(Attr&);
     ExceptionOr<Ref<Attr>> removeAttributeNode(Attr&);
    ...
    ExceptionOr<void> insertAdjacentHTML(const String& where, const String& html, std::optional<NodeVector&> addedNodes);
     ...
     ExceptionOr<Element*> insertAdjacentElement(const String& where, Element& newChild);
     ExceptionOr<void> insertAdjacentHTML(const String& where, const String& html);
     ExceptionOr<void> insertAdjacentText(const String& where, const String& text);
    ...
    virtual void blur();
     ...
     ExceptionOr<void> setOuterHTML(const String&);
     String innerText();
     String outerText();
    ...
    virtual bool matchesDefaultPseudoClass() const;
     ExceptionOr<bool> matches(const String& selectors);
    ...
    LayoutRect absoluteEventHandlerBounds(bool& includesFixedPositionElements);
    ...
    // the element even when the style doesn't change. This is mostly needed by the animation code.
     void invalidateStyleAndLayerComposition();
